<template>
  <main>
    ...
    <form @submit.prevent="signUp">
      ...
      <input class="form-control" type="text" id="username" v-model.trim="username"><br>
      
      <label for="password" class="form-label">비밀번호 : </label>
      <input class="form-control" type="text" id="password" v-model.trim="password"><br>

      <label for="email" class="form-label">이메일 : </label>
      <input class="form-control" type="text" id="email" v-model.trim="email">
...
import { ref } from 'vue'
import { SignUp } from '@/common/types/index';
